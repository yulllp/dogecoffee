      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: TextFormField(
              style: TextStyle(
                  color: Color.fromRGBO(227, 227, 227, 1.0), fontSize: 18),
              ...
              child: ElevatedButton(
                ...
                style: ButtonStyle(
                  ...
                  side: MaterialStateProperty.all<BorderSide>(
                    BorderSide(color: Color.fromRGBO(227, 227, 227, 1.0)), // Border color for all states
                  ),
                ),
                child: Padding(
          ...
          Padding(
            padding:
                const EdgeInsets.only(bottom: 25.0, left: 30.0, right: 30.0),
            child: Row(
